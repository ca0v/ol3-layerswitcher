...
define("ol3-layerswitcher/ol3-layerswitcher", ["require", "exports", "openlayers", "node_modules/ol3-fun/index"], function (require, exports, ol, index_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var olcss = {
    ...
    var LayerSwitcher = (function (_super) {
        ...
        function LayerSwitcher(options) {
            var _this = this;
            options = index_8.defaults(options || {}, exports.DEFAULT_OPTIONS);
        ...
        LayerSwitcher.create = function (options) {
            index_8.loadCss({ name: "ol3-layerswitcher", url: "../ol3-layerswitcher/css/ol3-layerswitcher.css" });
        ...
        LayerSwitcher.prototype.cssin = function () {
            ...
            var positions = index_8.pair("top left right bottom".split(" "), index_8.range(24)).map(function (pos) { return "." + className + "." + (pos[0] + (-pos[1] || "")) + " { " + pos[0] + ":" + (0.5 + pos[1]) + "em; }"; });
            index_8.cssin(className, positions.join("\n"));
        };
            ...
            if ("getLayers" in lyr && !lyr.get("combine")) {
                if (!lyr.get("label-only")) {
                    ...
                    input_1.addEventListener("change", function () {
                        index_8.toggle(ul_1, "hide-layer-group", !input_1.checked);
                ...
                result && index_8.toggle(ul_1, "hide-layer-group", !result.checked);
                li.appendChild(ul_1);
                ...
                if (lyr.get("type") === "base") {
                    ...
                    input_2.addEventListener("change", function () {
                        if (input_2.checked) {
                            index_8.asArray(_this.panel.getElementsByClassName("basemap"))
...
define("tests/extras/kill", ["require", "exports", "node_modules/ol3-fun/tests/base"], function (require, exports, base_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("tests/spec/layerswitcher", ["require", "exports", "openlayers", "node_modules/ol3-fun/tests/base", "tests/extras/kill", "tests/extras/setText", "index", "node_modules/ol3-fun/index"], function (require, exports, ol, base_14, kill_1, setText_1, index_9, index_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    base_14.describe("LayerSwitcher Tests", function () {
        base_14.it("LayerSwitcher", function () {
            base_14.should(!!index_9.LayerSwitcher, "LayerSwitcher");
        });
        base_14.it("DEFAULT_OPTIONS", function () {
            var options = index_9.DEFAULT_OPTIONS;
            checkDefaultInputOptions(options);
        });
        base_14.it("Renders in DOM", function () {
            ...
            var switcher = index_9.LayerSwitcher.create({
            ...
            switcher.showPanel();
            return index_10.slowloop([
                function () {
                    base_14.shouldEqual(document.getElementsByTagName("label").length, labelCount + 1, "Vectors label exists");
                }
            ]).then(kill_1.kill(switcher, 1000));
        });
        base_14.it("Renders in DOM (complex)", function () {
            var target = setText_1.createMapTarget();
            var map = setText_1.createMap(target);
            var switcher = index_9.LayerSwitcher.create({ map: map, position: "top right" });
            ...
            return index_10.slowloop([
                function () {
                    switcher.showPanel();
                    base_14.shouldEqual(switcher.isVisible(), true, "Panel is visible");
                },
                ...
                .then(function () {
                base_14.shouldEqual(vectors[0].getVisible(), false, "Parcel is hidden");
                vectors[0].setVisible(true);
                base_14.shouldEqual(vectors[1].getVisible(), true, "Address is visible");
                base_14.shouldEqual(vectors[2].getVisible(), true, "Address is visible");
                base_14.shouldEqual(tiles[0].getVisible(), true, "Bing is visible");
                base_14.shouldEqual(tiles[1].getVisible(), false, "OSM is hidden");
                tiles[1].setVisible(true);
                base_14.shouldEqual(tiles[1].getVisible(), true, "OSM is now visible");
                base_14.shouldEqual(tiles[0].getVisible(), true, "Bing is still visible");
                base_14.shouldEqual(switcher.isVisible(), true, "Panel is visible");
            })
    ...
    function checkDefaultInputOptions(options) {
        ...
        base_14.shouldEqual(options.className, "layer-switcher", "className");
        base_14.shouldEqual(options.closeOnClick, true, "closeOnClick");
        base_14.shouldEqual(options.closeOnMouseOut, false, "closeOnMouseOut");
        base_14.shouldEqual(options.openOnClick, true, "openOnClick");
        base_14.shouldEqual(options.openOnMouseOver, false, "openOnMouseOver");
        base_14.shouldEqual(options.target, undefined, "target");
        base_14.shouldEqual(options.tipLabel, "Layers", "tipLabel");
    }
});
define("tests/index", ["require", "exports", "tests/spec/packages", "tests/spec/layerswitcher"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
...
define("tests/spec/map", ["require", "exports", "node_modules/ol3-fun/tests/base", "tests/extras/kill", "tests/extras/once", "tests/extras/setText"], function (require, exports, base_15, kill_2, once_1, setText_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    base_15.describe("spec/map", function () {
        base_15.it("shows a map", function () {
